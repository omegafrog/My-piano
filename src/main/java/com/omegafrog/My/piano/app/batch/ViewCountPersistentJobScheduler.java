...
public class ViewCountPersistentJobScheduler {
    ...
    public void jobScheduled() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException,
        ...
        if (status == BatchStatus.FAILED) {
            ...
            jobExecution.getAllFailureExceptions().forEach(ex -> log.error("Batch failure exception: ", ex));
        }
