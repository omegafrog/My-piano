...
class PostControllerIntegrationTest {
  ...
  void getSessions() throws Exception {
    ...
    user1Session = testUtil.login(mockMvc, TestUtil.user1.getUsername(), TestUtil.user1.getPassword());
    testUtil.register(mockMvc, TestUtil.user2);
    user2Session = testUtil.login(mockMvc, TestUtil.user2.getUsername(), TestUtil.user2.getPassword());
  }
