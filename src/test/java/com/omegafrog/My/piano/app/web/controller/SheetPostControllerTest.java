...
class SheetPostControllerTest {
  ...
  void saveTest() throws Exception {
    ...
    MockHttpSession artistSession = testUtil.login(mockMvc, TestUtil.user1.getUsername(),
        TestUtil.user1.getPassword());
    MockHttpSession userSession = testUtil.login(mockMvc, TestUtil.user2.getUsername(),
  ...
  void deleteTest() throws Exception {
    ...
    MockHttpSession userSession = testUtil.login(mockMvc, TestUtil.user2.getUsername(),
        TestUtil.user2.getPassword());
    RegisterSheetPostDto registerDto = TestUtil.registerSheetPostDto(TestUtil.registerSheetDto1);
    SheetPostDto sheetPostDto = testUtil.writeSheetPost(mockMvc, artistSession, registerDto);
  ...
  void findAllTest() throws Exception {
    ...
    MockHttpSession userSession = testUtil.login(mockMvc, TestUtil.user2.getUsername(),
        TestUtil.user2.getPassword());
    RegisterSheetPostDto registerDto = TestUtil.registerSheetPostDto(TestUtil.registerSheetDto1);
    testUtil.writeSheetPost(mockMvc, userSession, registerDto);
    MockMultipartFile file = new MockMultipartFile("sheetFiles", "img.pdf", "application/pdf",
        new FileInputStream("src/test/sheet.pdf"));
    Long id = testUtil.writeSheetPost(mockMvc, userSession, registerDto).getId();

    RegisterSheetPostDto registerDto2 = TestUtil.registerSheetPostDto(TestUtil.registerSheetDto2);
    Long id2 = testUtil.writeSheetPost(mockMvc, userSession, registerDto2).getId();
